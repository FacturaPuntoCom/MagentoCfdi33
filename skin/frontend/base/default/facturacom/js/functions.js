...
console.log('$jq is using ' + $jq.fn.jquery + ' version');
var jQuery = $$$;
console.log('jQuery (default) is using ' + jQuery.fn.jquery + ' version');
...
$jq(function() {
  ...
  $jq('#f-step-one-form').submit(function(e){
    ...
    var action_url = $jq('#siteurl').val() + 'facturacion/index/one';
  ...
  $jq('#f-step-two-form').submit(function(e){
    ...
    var action_url = $jq('#siteurl').val() + 'facturacion/index/two';
    $jq.post(action_url, data, function(response) {
      $jq("#step-two .loader_content").hide();
  ...
  $jq('#step-three-button-next').click(function(e){
    ...
    var action_url = $jq('#siteurl').val() + 'facturacion/index/three';
    $jq.post(action_url, data, function(response) {
      $jq("#step-three").stop().hide();
      $jq("#step-three .loader_content").hide();
      ...
      if(response.data.invoice.status == 'success'){
        $jq('#btn-success-pdf').stop().show().attr('href','https://factura.com/api/publica/invoice/'+response.data.invoice.invoice_uid+'/pdf');
        $jq('#btn-success-xml').stop().show().attr('href','https://factura.com/api/publica/invoice/'+response.data.invoice.invoice_uid+'/xml');
      }else{
